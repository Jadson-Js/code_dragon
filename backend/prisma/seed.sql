...
insert into "public"."sessions" ("created_at", "feature_id", "id", "updated_at", "user_id") values ('2026-04-25 13:14:14.906', 1, '36785473-4fb3-4432-a065-0a24edf95556', '2026-04-25 13:14:14.906', '8f9e610e-ae40-4bd4-9438-959a256f2719') ON CONFLICT ("id") DO NOTHING;

insert into "public"."session_quizzes" ("created_at", "id", "quantity_questions", "quiz_objective_id", "seniority_id", "session_id", "specialty_id", "status", "updated_at", "user_id") values ('2026-04-25 13:14:14.91', '9e848da6-60d0-4466-ab59-c535a072aa70', 3, 1, 3, '36785473-4fb3-4432-a065-0a24edf95556', 2, 'IN_PROGRESS', '2026-04-25 13:15:42.069', '8f9e610e-ae40-4bd4-9438-959a256f2719') ON CONFLICT ("id") DO NOTHING;

insert into "public"."quiz_questions" ("alternatives", "code", "correct_alternative_index", "created_at", "id", "objective_id", "reports", "seniority_id", "session_quiz_id", "specialty_id", "stack_id", "statement", "subject_id", "updated_at") values ('{"Start, End, Promise, NextTick, Timeout","Start, End, NextTick, Promise, Timeout","Start, Timeout, NextTick, Promise, End","Start, End, Timeout, NextTick, Promise"}', E'console.log(''Start'');\\n\\nsetTimeout(() => {\\n  console.log(''Timeout'');\\n}, 0);\\n\\nPromise.resolve().then(() => {\\n  console.log(''Promise'');\\n});\\n\\nprocess.nextTick(() => {\\n  console.log(''NextTick'');\\n});\\n\\nconsole.log(''End'');', 1, '2026-04-25 13:14:55.817', 1, 1, 0, 3, '9e848da6-60d0-4466-ab59-c535a072aa70', 2, 2, 'No Node.js, o Event Loop é o mecanismo fundamental para processamento assíncrono. Ao lidar com diferentes tipos de tarefas, o motor de execução prioriza certas filas em detrimento de outras. Analise o código fornecido e identifique a ordem correta de saída no console.', 2, '2026-04-25 13:14:55.817'), ('{"O Node.js bloqueia a execução na linha do ''readFile'' até que o sistema operacional retorne os dados do arquivo, resultando na ordem de saída: A, B, C.","O Node.js delega a leitura do arquivo para a libuv e continua a execução do script. O callback é colocado na fila de eventos (Event Queue) e executado somente após o log ''C'', resultando na ordem: A, C, B.","O código resultará em erro, pois operações de I/O no Node.js são obrigatoriamente síncronas a menos que se utilize a biblioteca ''worker_threads''.","A saída será A, B, C, pois o Node.js utiliza múltiplas threads nativas do V8 para garantir que funções de callback sejam priorizadas sobre o fluxo principal do script."}', E'const fs = require(''fs'');\\n\\nconsole.log(''A'');\\nfs.readFile(''data.txt'', ''utf8'', (err, data) => {\\n  console.log(''B'');\\n});\\nconsole.log(''C'');', 1, '2026-04-25 13:15:05.995', 2, 1, 0, 3, '9e848da6-60d0-4466-ab59-c535a072aa70', 2, 2, 'No ecossistema Node.js, o modelo de I/O é frequentemente descrito como ''non-blocking'' (não-bloqueante). Analise o código fornecido e identifique a alternativa que descreve corretamente o comportamento do Node.js e a ordem de saída no console.', 2, '2026-04-25 13:15:05.995'), ('{"Início, Timer 1, Next Tick, Fim","Início, Fim, Next Tick, Timer 1","Início, Next Tick, Fim, Timer 1","Início, Fim, Timer 1, Next Tick"}', E'console.log(''Início'');\\n\\nsetTimeout(() => {\\n  console.log(''Timer 1'');\\n}, 0);\\n\\nprocess.nextTick(() => {\\n  console.log(''Next Tick'');\\n});\\n\\nconsole.log(''Fim'');', 1, '2026-04-25 13:15:41.981', 3, 1, 0, 3, '9e848da6-60d0-4466-ab59-c535a072aa70', 2, 3, 'Ao trabalhar com Node.js, é fundamental entender como o Event Loop gerencia a execução de operações assíncronas e a prioridade de diferentes filas de tarefas (microtasks e macrotasks). Considere o código abaixo e determine qual será a ordem correta das mensagens exibidas no console:', 3, '2026-04-25 13:15:41.981') ON CONFLICT ("id") DO NOTHING;

insert into "public"."session_quiz_stacks" ("average_score", "created_at", "id", "quiz_session_id", "score", "stack_id", "updated_at") values (NULL, '2026-04-25 13:14:14.914', '015c83fa-088d-4c07-8cfa-c86261a2afb1', '9e848da6-60d0-4466-ab59-c535a072aa70', NULL, 2, '2026-04-25 13:14:14.914'), (NULL, '2026-04-25 13:14:14.914', '3ca90d97-af90-40c4-bb9d-576d8135e90d', '9e848da6-60d0-4466-ab59-c535a072aa70', NULL, 3, '2026-04-25 13:14:14.914') ON CONFLICT ("id") DO NOTHING;

insert into "public"."session_quiz_subjects" ("average_score", "created_at", "id", "quiz_session_id", "score", "subject_id", "updated_at") values (NULL, '2026-04-25 13:14:14.914', '8a2b3c4d-5e6f-7a8b-9c0d-1e2f3a4b5c6d', '9e848da6-60d0-4466-ab59-c535a072aa70', NULL, 2, '2026-04-25 13:14:14.914'), (NULL, '2026-04-25 13:14:14.914', '9b0c1d2e-3f4a-5b6c-7d8e-9f0a1b2c3d4e', '9e848da6-60d0-4466-ab59-c535a072aa70', NULL, 3, '2026-04-25 13:14:14.914') ON CONFLICT ("id") DO NOTHING;