...
export default function GridItem({
  ...
  return (
    ...
    >
      {isSelected && (
        <div className="absolute top-4 right-4 flex items-center justify-center w-5 h-5 rounded-full border border-primary-1 bg-primary-1/10">
          <Check className="w-3 h-3 text-primary-1" />
        </div>
      )}
